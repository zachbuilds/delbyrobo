        ...
        for (Direction dir : Util.directions) {
            if (rc.getSoupCarrying() == RobotType.MINER.soupLimit) {
            	...
            	for (RobotInfo robot : robots) {
            		if (rc.getType() == RobotType.REFINERY && robot.getTeam() == rc.getTeam()) {
            			break;
            		} else if (refineryLoc == null) {
            			if(tryBuild(RobotType.REFINERY, dir)) {
	            			refineryLoc = rc.getLocation().add(dir);
	        				System.out.println("Refinery at: " + refineryLoc);
	        				System.out.println("I am at: " + rc.getLocation());
            			}
            			//broadcast refinery location
            		}
            	}
            }
        	if (tryMine(dir)) {
